...
float ZHashTable::get_value(unsigned long long board, int search_depth, bool& has_dead_board, bool& find_value)
{
...
void ZHashTable::set_value(unsigned long long board, int search_depth, float value, bool has_dead_board)
{
	unsigned long long hash_value = get_hash_value(board);
	BoardStatus& board_status = transposition_table_[hash_value & index_mask_];
