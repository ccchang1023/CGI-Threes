...
public:
	float get_value(unsigned long long board, int search_depth, bool& has_dead_board, bool& find_value);
	void set_value(unsigned long long board, int search_depth, float value, bool has_dead_board);
	void clear();
